    ...
    filmBack.click(function(){
        if($header.hasClass("portfolio--films-collection") || $header.hasClass("portfolio--films-display")){
            ...
            if($(".header__section4--portfolio-nav--back").hasClass("js--films-collections")){
                ...
                else if(document.querySelector('.film-title-player').innerHTML == "PROJECT: DAY OFF"){
                    document.getElementById('background').style.backgroundImage = 'url('+imageBackground[1]+')';
                }
                else if(document.querySelector('.film-title-player').innerHTML == "LARAWAN"){
                    document.getElementById('background').style.backgroundImage = 'url('+imageBackground[2]+')';
                }
                else if(document.querySelector('.film-title-player').innerHTML == "INTRA &mdash; SANTIAGO"){
                    document.getElementById('background').style.backgroundImage = 'url('+imageBackground[3]+')';
                }
                filmPresent();
            }
            else{
